...
static TextLayer *event_layer = NULL;
static TextLayer *eventstart_layer = NULL;
...
static void sync_tuple_changed_callback(const uint32_t key, const Tuple* new_tuple, const Tuple* old_tuple, void* context) {
  ...
  switch (key) {
    ...
    case WEATHER_CONDITION_KEY:
      ...
      break;
	case EVENT_KEY: {
  	    const char *eventtext = new_tuple->value->cstring;
	    snprintf(s_savedata.event, sizeof(s_savedata.event), eventtext);
        APP_LOG(APP_LOG_LEVEL_DEBUG, "Event: %s",s_savedata.event);
		text_layer_set_text(event_layer, s_savedata.event);
	  };	
	  break;
	case EVENTSTART_KEY:
	  if (strlen(new_tuple->value->cstring)>0) {
	 	strncpy(s_savedata.eventstart, new_tuple->value->cstring, sizeof(s_savedata.eventstart));
	  	APP_LOG(APP_LOG_LEVEL_DEBUG, "Event start: %s",s_savedata.eventstart);
      	text_layer_set_text(eventstart_layer, s_savedata.eventstart);
	  };  
      break;  
...
static void cal_layer_draw(Layer *layer, GContext *ctx) {
  ...
  graphics_fill_rect(ctx, GRect(0, 11, bounds.size.w, 46), 0, GCornerNone);
#ifndef PBL_COLOR
  rowtexttop1 = 7;
  rowtexttop2 = 19;
  rowtexttop3 = 31;
  ...
  cal_week_draw_dates(ctx, t->tm_mday - t->tm_wday + s_savedata.startday + s_savedata.cal_offset + extra_offset, 
                      curr_mon_len, prev_mon_len, GColorWhite, rowtexttop2, t->tm_mday);
...
static void window_load(Window *window) {
...
#if (defined(PBL_HEALTH))
  APP_LOG(APP_LOG_LEVEL_DEBUG, "Pebble Health used");
#endif	
  ...
  s_savedata.event[0] = '\0';
  s_savedata.eventstart[0] = '\0';	
  ...
  current_layer = layer_create(GRect(0, 0, bounds.size.w, 58)); 
  ...
  week_layer = text_layer_create(GRect(122, 23, 24, 15));
  ...
  date_layer = text_layer_create(GRect(54, 30, 89, 26));
  ...
  wind_speed_layer = text_layer_create(GRect(45, 34, 45, 26));
  ...
  forecast_layer = layer_create(GRect(0, 57, bounds.size.w, 64));

  status_bg_layer = text_layer_create(GRect(0, -4, bounds.size.w, 17));
...
#if (defined(PBL_HEALTH))
  steps_layer = layer_create(GRect(0, -4, bounds.size.w, 17));
  ...
  high_label_layer = text_layer_create(GRect(1, 8, 10, 18));
  text_layer_set_text_color(high_label_layer, GColorWhite);
  text_layer_set_background_color(high_label_layer, GColorClear);
  text_layer_set_font(high_label_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  ...
  high_temp_layer = text_layer_create(GRect(7, 8, 45, 18));
  text_layer_set_text_color(high_temp_layer, GColorWhite);
  text_layer_set_background_color(high_temp_layer, GColorClear);
  text_layer_set_font(high_temp_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  ...
  low_label_layer = text_layer_create(GRect(1, 22, 10, 18));
  text_layer_set_text_color(low_label_layer, GColorWhite);
  text_layer_set_background_color(low_label_layer, GColorClear);
  text_layer_set_font(low_label_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  ...
  low_temp_layer = text_layer_create(GRect(7, 22, 45, 18));
  text_layer_set_text_color(low_temp_layer, GColorWhite);
  text_layer_set_background_color(low_temp_layer, GColorClear);
  text_layer_set_font(low_temp_layer, fonts_get_system_font(FONT_KEY_GOTHIC_18));
  ...
  sun_rise_set_layer = text_layer_create(GRect(100, 26, 47, 14));
  ...
  sun_layer = bitmap_layer_create(GRect(113, 15, 20, 14));
  layer_add_child(forecast_layer, bitmap_layer_get_layer(sun_layer));
  
  eventstart_layer = text_layer_create(GRect(0, 41, 144, 24));
  text_layer_set_text_color(eventstart_layer, GColorWhite);
  text_layer_set_background_color(eventstart_layer, GColorClear);
  text_layer_set_font(eventstart_layer, fonts_get_system_font(FONT_KEY_GOTHIC_14_BOLD));
  text_layer_set_text_alignment(eventstart_layer, GTextAlignmentLeft);
  text_layer_set_overflow_mode(eventstart_layer, GTextOverflowModeTrailingEllipsis);
  text_layer_set_text(eventstart_layer, "-");
  layer_add_child(forecast_layer, text_layer_get_layer(eventstart_layer));	
	
  event_layer = text_layer_create(GRect(0, 50, 144, 24));
  text_layer_set_text_color(event_layer, GColorWhite);
  text_layer_set_background_color(event_layer, GColorClear);
  text_layer_set_font(event_layer, fonts_get_system_font(FONT_KEY_GOTHIC_14));
  text_layer_set_text_alignment(event_layer, GTextAlignmentLeft);
  text_layer_set_overflow_mode(event_layer, GTextOverflowModeTrailingEllipsis);
  text_layer_set_text(event_layer, "No events");
  layer_add_child(forecast_layer, text_layer_get_layer(event_layer));
  ...
  text_layer_enable_screen_text_flow_and_paging(event_layer, 1);
#endif
  ...
  Tuplet initial_values[] = {
	...
	MyTupletCString(EVENT_KEY, s_savedata.event),
    MyTupletCString(EVENTSTART_KEY, s_savedata.eventstart),
